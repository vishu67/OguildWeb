						...
						<div class="gutenify-corporate-header-left admin-col">
							<div class="gutenify-corporate-card-header-button-group">
								...
								<a href="<?php echo admin_url( 'admin.php?page=gutenify-template-kits' ); ?>"
                                                class="gutenify-corporate-admin-button" rel="noreferrer"><span class="dashicons dashicons-admin-customizer"></span> <?php esc_html_e( 'Template Kits', 'gutenify-corporate' ); ?></a>
								<?php endif; ?>
								<?php if ( ! $gutenify_is_installed && ! $gutenify_is_active ) : ?>
								<a href="javascript:void(0);" class="gutenify-corporate-admin-button gutenify-corporate-install-gutenify"><span class="dashicons dashicons-admin-customizer"></span> <?php esc_html_e( 'Import template', 'gutenify-corporate' ); ?> </a>
								<?php endif; ?>
								<?php if ( $gutenify_is_installed && ! $gutenify_is_active ) : ?>
								<a href="javascript:void(0);" class="gutenify-corporate-admin-button gutenify-corporate-activate-gutenify"><span class="dashicons dashicons-admin-customizer"></span> <?php esc_html_e( 'Import template', 'gutenify-corporate' ); ?> </a>
								<?php endif; ?>
								<?php if ( $gutenify_is_active && ! class_exists( 'Gutenify_Pro' ) ) : ?>
								<a href="https://gutenify.com/pricing" class="gutenify-corporate-admin-button" rel="noreferrer" target="_blank"><i
                                                        class="fa fa-paint-brush"></i> <?php esc_html_e( 'Get Gutenify Pro', 'gutenify-corporate' ); ?> </a>
								<?php endif; ?>
								<a  href="https://gutenify.com/documentations/" class="gutenify-corporate-admin-button premium-button"
                ...
                <div class="gutenify-corporate-about-container subscribe-panel admin-grid-3">
                        <div class="admin-col">
                                <div class="gutentor-get-started-content">
                                        <h3><?php esc_html_e( 'Gutenify Template Kits', 'gutenify-corporate' ); ?></h3>
                                        <p><?php esc_html_e( 'Gutenify has pre-built template kits for your site which will give your
                                        ...
                                        <ul>
                                                <li> <span class="dashicons dashicons-welcome-learn-more"></span> <a
                                                                ...
                                                                target="_blank" rel="noreferrer"><?php esc_html_e( 'Learn about Template
                                                                Kits', 'gutenify-corporate' ); ?></a></li>
                                                ...
                                                <li> <span class="dashicons dashicons-search"></span> <a
                                                                ...
                                                                rel="noreferrer"><?php esc_html_e( 'Browse Template Kits', 'gutenify-corporate' ); ?></a></li>
												<?php endif; ?>
												<?php if ( ! defined('GUTENIFY_VERSION') ) : ?>
                                                <li> <span class="dashicons dashicons-search"></span> <a
                        ...
                        <div class="admin-col">
                                <div class="gutenify-corporate-get-started-content">
                                        <h3><?php esc_html_e( 'Import Templates (Patterns)', 'gutenify-corporate' ); ?></h3>
                                        <p><?php esc_html_e( 'From Edit screen of page/post, you can easily import Beautiful
                                                Templates', 'gutenify-corporate' ); ?></p>
                                        <ul>
                                                <li> <span class="dashicons dashicons-welcome-learn-more"></span> <a
                                                                ...
                                                                Templates', 'gutenify-corporate' ); ?></a></li>
                                                <li> <span class="dashicons dashicons-edit"></span> <a
                                                                href="<?php echo admin_url( 'post-new.php?post_type=page' ); ?>"
                                                                rel="noreferrer"><?php esc_html_e( 'Create page to add template', 'gutenify-corporate' ); ?></a>
                                                </li>
                                        </ul>
                                </div>
                        </div>
                ...
                <div class="gutenify-corporate-about-container gutenify-corporate-compare-table">
                        <div class="admin-grid-1">
                                <h3>
									...
									<p class="gutenify-corporate-compare-table-subtitle"><a href="https://gutenify.com/pricing/" target="__blank"><?php esc_html_e( 'Checkout all features', 'gutenify-corporate' ); ?> <i class="dashicons dashicons-arrow-right-alt"></i></a></p>
                                <table>
                                        <thead>
                                                <tr>
                                                        <th>
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                        <td>
                                                                <?php esc_html_e( 'Premium templates kits', 'gutenify-corporate' ); ?>
                                                                </th>
                                                ...
                                                <tr>
                                                        <td>
                                                                <?php esc_html_e( 'Premium Templates (Patterns)', 'gutenify-corporate' ); ?>
                                                                </th>
                                                        <td><span class="dashicons dashicons-no"></span></th>
                                                        <td><span class="dashicons dashicons-yes"></span></th>
                                                </tr>
                ...
                <div class="feature-list">
                        <div class="gutenify-corporate-about-container gutenify-about-content">
                                <div class="gutenify-corporate-admin-card features">
                                        ...
                                        <ul class="gutenify-corporate-options-features">
                                                ...
                                                <li><span class="dashicons dashicons-yes"></span>
												<?php esc_html_e( 'Template Kits', 'gutenify-corporate' ); ?>   </li>
                                                <li><span class="dashicons dashicons-yes"></span>
                        ...
                        <div class="gutenify-corporate-about-side">
                                ...
                                <div class="gutenify-corporate-admin-card cart-two">
                                        ...
                                        <p><?php esc_html_e( 'We are always ready with all fix issues you stuck to ensure smoothly works with gutenify', 'gutenify-corporate' ); ?></p><a href="https://gutenify.com/contact/"
		...
		<?php if ( defined('GUTENIFY_VERSION') && class_exists( 'Gutenify_Pro' ) ) : ?>
								<a href="<?php echo admin_url( 'admin.php?page=gutenify-template-kits' ); ?>"
                                                class="gutenify-corporate-admin-button" rel="noreferrer"><i
                                                        class="fa fa-paint-brush"></i> <?php esc_html_e( 'Template Kits', 'gutenify-corporate' ); ?></a>
								<?php endif; ?>
								<?php if ( ! defined('GUTENIFY_VERSION') || ! class_exists( 'Gutenify_Pro' ) ) : ?>
								<a href="https://gutenify.com/pricing" class="gutenify-corporate-admin-button" rel="noreferrer" target="_blank"><i
                                                        class="fa fa-paint-brush"></i> <?php esc_html_e( 'Get Gutenify Pro', 'gutenify-corporate' ); ?> </a>
