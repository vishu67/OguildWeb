...
<div class="notice notice-success is-dismissible gutenify-corporate-admin-notice">
	<div class="gutenify-corporate-admin-notice-wrapper">
		...
		<p><?php esc_html_e( 'We strongly recommend installing plugin: ', 'gutenify-corporate' ); ?> <strong><?php esc_html_e( 'Gutenify', 'gutenify-corporate' ); ?></strong></p>
		<p><strong><?php esc_html_e( 'Gutenify', 'gutenify-corporate' ); ?></strong> <?php esc_html_e( 'provides multiple template kit and also add advance features to your site.', 'gutenify-corporate' ); ?></p>
		<a href="<?php echo esc_url( admin_url( 'themes.php?page=gutenify-corporate-info' ) ); ?>" class="gutenify-corporate-admin-notice-primary-button"><?php esc_html_e( 'Get Templates', 'gutenify-corporate' ); ?></a>
