 ...
 * @return void
 */
function gutenify_corporate_get_color_value( $value ) {
...
function gutenify_corporate_global_styles_vars() {
	...
	if ( ! empty( $core_button_styles['color']['background'] ) ) {
		$element_css_styles .= '--wp--custom--core-button--color--background: ' . gutenify_corporate_get_color_value( $core_button_styles['color']['background'] ) . ';';
	}

	if ( ! empty( $core_button_styles['color']['text'] ) ) {
		// var(--wp--preset--color--vivid-red)
		$element_css_styles .= '--wp--custom--core-button--color: ' . gutenify_corporate_get_color_value( $core_button_styles['color']['text'] ) . ';';
	}
...
add_action( 'wp_enqueue_scripts', 'gutenify_corporate_global_styles_vars', 100 );
