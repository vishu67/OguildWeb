...
return array(
	...
	'content'    => '<!-- wp:group {"style":{"spacing":{"padding":{"top":"100px","bottom":"100px"}}},"backgroundColor":"zeever-bgsoft","layout":{"wideSize":"1170px","contentSize":"1170px"}} -->
                ...
                <div class="wp-block-columns"><!-- wp:column -->
                <div class="wp-block-column"><!-- wp:heading {"textAlign":"left","style":{"typography":{"fontStyle":"normal","fontWeight":"600","fontSize":"48px"}},"textColor":"zeever-primary","className":"is-style-lineseparator zeever-animate zeever-move-right zeever-delay-1"} -->
                <h2 class="has-text-align-left is-style-lineseparator zeever-animate zeever-move-right zeever-delay-1 has-zeever-primary-color has-text-color" style="font-size:48px;font-style:normal;font-weight:600">Services</h2>
                <!-- /wp:heading -->
                ...
                <!-- wp:group {"style":{"spacing":{"padding":{"top":"40px"}}},"className":"zeever-animate zeever-move-up zeever-delay-3","layout":{"contentSize":"1170px"}} -->
                ...
                <!-- wp:heading {"textAlign":"left","style":{"spacing":{"margin":{"top":"30px","bottom":"20px"}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"zeever-primary","fontSize":"large"} -->
                <h2 class="has-text-align-left has-zeever-primary-color has-text-color has-large-font-size" style="font-style:normal;font-weight:600;margin-top:30px;margin-bottom:20px">Digital Strategy</h2>
                <!-- /wp:heading -->
                ...
                <!-- wp:heading {"textAlign":"left","style":{"spacing":{"margin":{"top":"20px"}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"black","fontSize":"large"} -->
                <h2 class="has-text-align-left has-black-color has-text-color has-large-font-size" style="font-style:normal;font-weight:600;margin-top:20px">UI Design</h2>
                <!-- /wp:heading -->
                ...
                <!-- wp:heading {"textAlign":"left","style":{"spacing":{"margin":{"top":"30px","bottom":"20px"}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"zeever-primary","fontSize":"large"} -->
                <h2 class="has-text-align-left has-zeever-primary-color has-text-color has-large-font-size" style="font-style:normal;font-weight:600;margin-top:30px;margin-bottom:20px">Content Writing</h2>
                <!-- /wp:heading -->
                ...
                <!-- wp:heading {"textAlign":"left","style":{"spacing":{"margin":{"top":"20px"}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"zeever-primary","fontSize":"large"} -->
                <h2 class="has-text-align-left has-zeever-primary-color has-text-color has-large-font-size" style="font-style:normal;font-weight:600;margin-top:20px">Marketing Strategy</h2>
                <!-- /wp:heading -->
                ...
                <!-- wp:heading {"textAlign":"left","style":{"spacing":{"margin":{"top":"20px"}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"zeever-primary","fontSize":"large"} -->
                <h2 class="has-text-align-left has-zeever-primary-color has-text-color has-large-font-size" style="font-style:normal;font-weight:600;margin-top:20px">Web Development</h2>
                <!-- /wp:heading -->
                ...
                <!-- wp:heading {"textAlign":"left","style":{"spacing":{"margin":{"top":"20px"}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"zeever-primary","fontSize":"large"} -->
                <h2 class="has-text-align-left has-zeever-primary-color has-text-color has-large-font-size" style="font-style:normal;font-weight:600;margin-top:20px">Social Media</h2>
                <!-- /wp:heading -->
